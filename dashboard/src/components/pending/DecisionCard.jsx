    ...
    <div className={`rounded-lg border ${isStale ? 'border-amber-800/50' : 'border-gray-200 dark:border-gray-800'} bg-white dark:bg-gray-900 overflow-hidden`}>
      ...
      {expanded && (
        <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4 space-y-4">
          ...
          {/* Stale warning */}
          {isStale && (
            <div data-testid="stale-warning-badge" className="rounded-md bg-amber-50 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-800/50 px-3 py-2 text-xs text-amber-700 dark:text-amber-400">
