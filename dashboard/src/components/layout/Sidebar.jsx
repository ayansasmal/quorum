...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-[var(--sidebar-width)] flex-col bg-gray-900 border-r border-gray-800">
      {/* Brand */}
      <div className="flex h-14 items-center px-5 border-b border-gray-800">
        <span className="text-sm font-semibold tracking-widest text-white uppercase">Quorum</span>
      </div>
      ...
      <div className="border-t border-gray-800 p-2">
        <button
          onClick={logout}
          className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-800/60 hover:text-gray-300 transition-colors"
        >
